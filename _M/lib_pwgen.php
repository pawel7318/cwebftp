<?php
	...
	/**
	 * Port of the famous GNU/Linux passwd Generator ("pwgen") to PHP.
	...
	class PWGen {
		...
		/**
		 * @param length	Length of the generated passwd. Default: 8
		 * @param secure	Generate completely random, hard-to-memorize passwds. These should only
		 * 			be used for machine passwds, since otherwise it's almost guaranteed that
		 * 			users will simply write the passwd on a piece of paper taped to the monitor...
		 * @param numerals	Include at least one number in the passwd. This is the default.
		 * @param capitalize	Include at least one capital letter in the passwd. This is the default.
		 ...
		 *			passwds significantly, and as such reduces the quality of the passwds.
		 *			It may be useful for users who have bad vision, but in general use of this
		 *			option is not recommended.
		 * @param no-vowels	Generate random passwds that do not contain vowels or numbers that might be
		 * 			mistaken for vowels. It provides less secure passwds to allow system
		 * 			administrators to not have to worry with random passwds accidentally contain
		 * 			offensive substrings.
		 * @param symbols	Include at least one special character in the passwd.
		 */
		...
		/**
		 * Length of the generated passwd. Default: 8
		 */
		...
		/**
		 * Generate completely random, hard-to-memorize passwds. These should only used for machine passwds,
		 * since otherwise it's almost guaranteed that users will simply write the passwd on a piece of paper
		 * taped to the monitor...
		 * Please note that this function implies that you want passwds which include symbols, numerals and
		 * capital letters.
		 */
		...
		/**
		 * Include at least one number in the passwd. This is the default.
		 */
		...
		/**
		 * Include at least one capital letter in the passwd. This is the default.
		 */
		 ...
		 * 'O'. This reduces the number of possible passwds significantly, and as such reduces the quality of
		 * the passwds. It may be useful for users who have bad vision, but in general use of this option is
		 * not recommended.
		 */
		...
		/**
		 * Generate random passwds that do not contain vowels or numbers that might be mistaken for vowels. It
		 * provides less secure passwds to allow system administrators to not have to worry with random
		 * passwds accidentally contain offensive substrings.
		 */
		...
		private function pw_phonemes() {
			...
			$this->passwd = implode('', $this->passwd);
		}
		...
		/**
		 * Returns the last generated passwd. If there is none, a new one will be generated.
		 */
		public function __toString() {
			return (empty($this->passwd) ? $this->generate() : $this->passwd);
		}
